...
@section('meta', 'Simple, honest pricing for HelpGenie Pro. Every plan includes the Genie assistant, automations and free guided migration. No setup fees, cancel anytime.')
  ...
  <div class="container">
    <div data-reveal>
      ...
      <p class="lead">No locked-away essentials, no surprise add-ons. Every plan includes the
        Genie assistant, automation and free guided migration — you simply pick the volume
        that fits.</p>
    </div>
...
<section class="section-tight">
  <div class="container-wide">
    <div class="pgrid">
      ...
      <div class="pcard" data-reveal data-delay="1">
        ...
        <ul class="plist">
          ...
          <li><span class="tick">✓</span> Genie assistant · 200 resolutions / mo</li>
      ...
      <div class="pcard pop" data-reveal data-delay="2">
        ...
        <ul class="plist">
          ...
          <li><span class="tick">✓</span> Genie assistant · 2,000 resolutions / mo</li>
      ...
      <div class="pcard" data-reveal data-delay="3">
        ...
        <ul class="plist">
          ...
          <li><span class="tick">✓</span> Unlimited Genie resolutions</li>
          <li><span class="tick">✓</span> Custom Genie actions &amp; API tools</li>
    ...
    <div class="note-card center" data-reveal style="margin-top:36px;max-width:900px;margin-left:auto;margin-right:auto">
      ...
      <p>Free guided migration from your old help desk · the Genie assistant · no-code automation ·
  ...
  <div class="container">
    ...
    <div class="tgrid">
      <div class="tcard" data-reveal data-delay="1">
        ...
        <p class="quote">"We were paying for four separate tools. HelpGenie Pro replaced all of
...
<section class="section bg-white" id="faq">
  <div class="container">
    ...
    <div class="faq" data-reveal>
      @php
        $faqs = [
          ['Is there really a free trial?', 'Yes — every plan starts with a 14-day trial that unlocks every feature, including the Genie assistant. No credit card is needed to begin, and nothing is charged until you decide to stay.'],
          ...
          ['What counts as a Genie resolution?', 'A resolution is counted when the Genie fully answers a customer without a human agent stepping in. Conversations that are escalated to a person do not count toward your monthly allowance.'],
